...
struct StartupPerformanceTests {
    ...
    @Test func startupBackgroundWorkUsesVisibleSerialQueue() throws {
        ...
        #expect(models.contains("var priority: Int"))
        ...
        #expect(functionBody(named: "queueBackgroundTask", in: store).contains("queuedBackgroundTaskKinds.firstIndex(where: { $0.priority > kind.priority })"))
